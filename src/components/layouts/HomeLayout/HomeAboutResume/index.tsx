...
export const SmallAbout: React.FC<SmallAboutProps> = () => {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        if (entries[0].isIntersecting) {
          setIsVisible(true);
          observer.disconnect(); // Executa a animação apenas uma vez
        }
      },
      { threshold: 0.3 } // A visibilidade é detectada quando 30% da seção está visível
    );
  ...
  return (
    <MovLayout maxWidthContainer="100vw">
      <Box
        ref={sectionRef}
        className={`small-about-container ${isVisible ? "visible" : ""}`}
      >
        ...
        <Box className="small-about-description">
          <h1 className="small-about-subtitle">Bem-vindo à MOV Produtora!</h1>
          ...
          <ul className="custom-checklist">
            ...
            <li className="small-about-text">
              ...
              registramos cada detalhe com cuidado e criatividade para eternizar
          ...
          <p className="small-about-text">
            ...
            dar vida à sua visão e mostrar o melhor da sua história. Vamos criar
